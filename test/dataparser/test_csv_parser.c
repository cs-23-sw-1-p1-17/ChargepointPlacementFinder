...
void test_parsing_of_edges_on_example_data(void) {
    ...
    // ASSERTIONS
    // Test of Names
    TEST_ASSERT_EQUAL_STRING_MESSAGE("E45 oestjyske Motorvej paa Vejlefjordsbroen", edges[10].name,
                                     "Failed reading correct edge name");
    ...
    TEST_ASSERT_EQUAL_STRING_MESSAGE("E45 mellem Smidstrup Praestemark og Kolding N", edges[13].name,
                                     "Failed reading correct edge name");
